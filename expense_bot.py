...
def main():
    ...
    try:
        # do_quote=False: bot javoblari foydalanuvchi xabariga "javob"
        # (reply/quote) sifatida yuborilmasin — aks holda guruh chatlarida
        # Telegram avtomatik ravishda xabarni "citata" qilib ko'rsatib,
        # keyingi yozuvda ham "В ответ..." qalqib chiqishiga sabab bo'ladi.
        defaults = Defaults(parse_mode=ParseMode.HTML, do_quote=False)
    except TypeError:
        # Eski python-telegram-bot versiyalarida bu parametr "quote" deb ataladi
        defaults = Defaults(parse_mode=ParseMode.HTML, quote=False)
